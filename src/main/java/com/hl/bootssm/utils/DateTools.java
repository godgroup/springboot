...
public class DateTools {
    ...
    public static void main(String[] args) {
        Date d1 = stringToDate("2017-09-09", "yyyy-MM-dd");
        Long time1 = d1.getTime();
        Date d2 = stringToDate("2017-09-08", "yyyy-MM-dd");
    ...
    public static int getSecond(Date date) {
        ...
        if (length > len) {
            return Integer.valueOf(timestamp.substring(0, length - len));
        } else {
            return 0;
        }
    }
...
//        cal.set(Calendar.MILLISECOND, 999);
    ...
    public static String getSysTimeLong() {
        Date now = getCurrentDate();
        return dateToString(now, TIME_PATTERN_SESSION);
    }
}